...
df1 = pd.read_csv('./../logs/simulation.log', sep=' ', index_col=None, names=['ts', 'angle', 'ax', 'ay', 'az', 'wx', 'wy', 'wz', 'mx', 'my', 'mz'])

df2 = pd.read_csv('./../logs/calculated_angles.log', sep=' ', names=['ts', 'roll', 'pitch', 'yaw'])
